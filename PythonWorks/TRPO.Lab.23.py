...
class Facade:
    ...
    def operation(self) -> str:
        ...
        results = []
        results.append("Фасад обрабатывает подсистемы:")
        results.append(self._subsystem1.operation1())
        results.append(self._subsystem2.operation1())
        results.append("Фасад просматривает статусы процессов:")
...
class Subsystem2:
    ...
    def operation1(self) -> str:
        return "Photoshop: инициализация!"

    # ...

    def operation_z(self) -> str:
        return "Photoshop: запущено!"
